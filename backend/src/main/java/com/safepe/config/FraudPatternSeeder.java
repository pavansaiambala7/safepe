...
/**
 * Fraud Pattern Seeder — RAG Knowledge Base
 * ============================================
 * Seeds the database with 20+ known fraud patterns across 8 categories.
 * These patterns form the knowledge base for the RAG pipeline,
 * enabling semantic similarity search against incoming transactions.
 *
 * Categories: PHISHING, UPI_FRAUD, LOAN_SCAM, KYC_FRAUD,
 *             LOTTERY_SCAM, INVESTMENT_FRAUD, IMPERSONATION, VISHING
 */
@Component
